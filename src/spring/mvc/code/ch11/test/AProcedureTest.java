...
import spring.mvc.code.ch11.mapper.Ch11_UserProMapper;
...
//            t.testRemoveUser(sqlSession);
    ...
    public void testSaveUser(SqlSession sqlSession){
        // 獲得UserMapper接口的代理對象
        Ch11_UserProMapper um = sqlSession.getMapper(Ch11_UserProMapper.class);
        Ch11_User_Pro user = new Ch11_User_Pro("test","男",23);
...
//		User user = new User("scott","男",25);
    ...
    public void testSelectUser(SqlSession sqlSession){
        ...
        Ch11_UserProMapper um = sqlSession.getMapper(Ch11_UserProMapper.class);
        // 調用查詢所有User數據的方法
        List<Ch11_User_Pro> users = um.selectUser();
        // 遍歷打印每一個User對象
    ...
    public void testSelectUserById(SqlSession sqlSession){
        ...
        Ch11_UserProMapper um = sqlSession.getMapper(Ch11_UserProMapper.class);
        // 調用根據id查詢User數據的方法
        Ch11_User_Pro user = um.selectUserById(1);
