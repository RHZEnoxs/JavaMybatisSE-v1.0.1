...
import spring.mvc.code.ch11.mapper.Ch11_UserTwoLevelCacheMapper;
...
public class ATwoLevelCacheTest {
    public static void main(String[] args)  {
        ...
        // 獲得UserMapping對像
        Ch11_UserTwoLevelCacheMapper um = sqlSession1.getMapper(Ch11_UserTwoLevelCacheMapper.class);
        ...
        // 再次獲得UserMapping對像
        um = sqlSession2.getMapper(Ch11_UserTwoLevelCacheMapper.class);
